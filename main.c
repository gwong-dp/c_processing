...
void GERALD_DEMO_INIT(void) {

	CP_Image image = CP_Image_Load("./Assets/dream.png");
	CP_Image_Free(&image);
}

void GERALD_DEMO_UPDATE(void) {

}

void GERALD_DEMO_EXIT(void) {
...
//	CP_Engine_SetNextGameState(initbuff, updatebuff, NULL);
	...
	//CP_Engine_SetNextGameState(JUSTIN_DEMO_INIT, JUSTIN_DEMO_UPDATE, NULL);
	
	//CP_Engine_SetNextGameState(GERALD_DEMO_INIT, GERALD_DEMO_UPDATE, GERALD_DEMO_EXIT);
