...
{
	//CP_Graphics_ClearBackgroundCommand* commandData = CP_Commands_PushStruct(CP_Graphics_ClearBackgroundCommand, CP_Commands_GetCurrentFrame(), COMMAND_GRAPHICS_CLEAR_BACKGROUND);
	//commandData->color = c;
...
{
#if GERALD
	CP_Graphics_DrawRectCommand* data = CP_Commands_PushStruct(CP_Graphics_DrawRectCommand, CP_Commands_GetCurrentFrame(), COMMAND_GRAPHICS_DRAW_RECT);
	data->x = x;
	data->y = y;
	data->w = w;
	data->h = h;
...
{
#if GERALD
	CP_Graphics_DrawCircleCommand* data = CP_Commands_PushStruct(CP_Graphics_DrawCircleCommand, CP_Commands_GetCurrentFrame(), COMMAND_GRAPHICS_DRAW_CIRCLE);
	data->x = x;
	data->y = y;
	data->d = d;
#endif
