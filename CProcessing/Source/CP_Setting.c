...
{
#if GERALD
	CP_Settings_SetFillCommand* commandData = CP_Commands_PushStruct(CP_Settings_SetFillCommand, CP_Commands_GetCurrentFrame(), COMMAND_SETTINGS_SET_FILL);
	commandData->color = c;
#endif
